'''
File: heuristic_real_data_experience.py
Project: Job Orchestration
Description:
-----------
use the heuristic algorithm to solve the real data
-----------
Author: 626
...
# create data
tasks_df = pd.read_csv("Job_Scheduling.csv")
tasks_dependency_df = pd.read_csv("Tasks_Dependency.csv")
...
# save solution
export_results.export_results_to_csv(solution_t, instance.tasks, "real_data")
